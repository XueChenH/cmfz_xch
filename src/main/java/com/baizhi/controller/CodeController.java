...
public class CodeController{
	...
	public String getcode(HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		// 锟矫碉拷锟斤拷证锟斤拷锟斤拷锟?锟斤拷锟斤拷证锟斤拷图片锟斤拷锟斤拷证锟斤拷锟街凤拷
		Captcha captcha = configurableCaptchaService.getCaptcha();
		// 取锟斤拷锟斤拷证锟斤拷锟街凤拷锟斤拷锟絊ession
	...
	public void init() throws ServletException {
		...
		// 锟斤拷色锟斤拷锟斤拷锟斤拷锟斤拷,使锟斤拷一锟斤拷锟斤拷围锟节碉拷锟斤拷锟缴?
		...
		// 锟斤拷锟斤拷址锟斤拷锟斤拷锟斤拷,去锟斤拷锟斤拷锟斤拷谆锟斤拷锟斤拷锟斤拷母锟斤拷锟斤拷锟斤拷,锟斤拷o锟斤拷0锟斤拷
